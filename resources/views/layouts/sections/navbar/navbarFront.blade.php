    ...
    <div class="container">
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
            ...
            <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    @auth
                        ...
                        <li class="nav-item {{ Str::contains($currentRouteName, 'api') ? 'active' : '' }}">
                            <a class="nav-link fw-medium" href="{{ route('api') }}">API</a>
                        </li>
                    @endauth
                </ul>
            </div>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li>
                    @auth
                        <a href="{{ route('logout') }}" class="btn btn-danger"><span class="tf-icons icon-base ti tabler-logout scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Logout</span></a>
                    @else
