document.addEventListener("DOMContentLoaded", function () {
    {
        let e = document.querySelector("#formPricing");
        e && "undefined" != typeof FormValidation && FormValidation.formValidation(e, {
            fields: {
                gmail_price: {
                    validators: {
                        notEmpty: {message: "Please enter gmail price"},
                        numeric: {message: "The value must be a number"},
                    }
                },
                outlook_price: {
                    validators: {
                        notEmpty: {message: "Please enter outlook price"},
                        numeric: {message: "The value must be a number"},
                    }
                },
                custom_price: {
                    validators: {
                        notEmpty: {message: "Please enter custom price"},
                        numeric: {message: "The value must be a number"},
                    }
                },
            },
